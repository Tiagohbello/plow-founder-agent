...
`approval_ref` identifying the authority-bearing approval message, and `validation_ref` identifying
...
- Run `finish --id N --outcome completed|uncertain|dismissed --ref <evidence>`.
  ...
  their linked ledgers and obtain a new concrete decision in an authority-bearing turn before any
